...
Пошаговая инструкция для GitHub Desktop находится в файле [`PUBLISH_WITH_GITHUB_DESKTOP.md`](./PUBLISH_WITH_GITHUB_DESKTOP.md).

Репозиторий назначения: `RawenHold/Buyursin`.
